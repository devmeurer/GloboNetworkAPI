...
class IPv6DeleteTestCaseV4(NetworkApiTestCase):
    ...
    def test_try_delete_ipv6_used_by_created_vip_request(self):
        ...
        self.compare_values(
            'IPv6 can not be removed because it is in use by Vip Request 2',
            response.data['detail']
        )
