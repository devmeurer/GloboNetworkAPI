"""
Use example:
python networkapi/plugins/Juniper/JUNOS/samples/sample_standalone_modular.py -device 'HOST' -user 'SSH_USER' -password 'SSH_USER_PASSWORD'
"""
...
def main(device, username, password):
    ...
    plugin.exec_command(
        command='set interfaces gr-0/0/0 description "Some description sample standalone modular gr-0/0/0"')
