...
urlpatterns = [
    path('', group_l3_add_resource.handle_request, name='group_l3.add'),
    path('all/', group_l3_get_all_resource.handle_request, name='group_l3.get.all'),
    path('<str:id_groupl3>/', group_l3_alter_remove_resource.handle_request, name='group_l3.update.remove.by.pk'),
]
