...
urlpatterns = [
    path('', environment_resource.handle_request, name='environment.search.insert'),
    path('list/', environment_list_resource.handle_request, name='environment.list.all'),
    path('equip/<int:id_equip>/', environment_by_equip_resource.handle_request, name='environment.list.by.equip'),
    # path('ipconfig/', environment_resource.handle_request, {'ip_config': True}, name='environment.insert.ipconfig'),
    path('divisao_dc/<int:id_divisao_dc>/', environment_resource.handle_request, name='environment.search.by.divisao_dc'),
    path('divisao_dc/<int:id_divisao_dc>/ambiente_logico/<int:id_amb_logico>/', environment_resource.handle_request, name='environment.search.by.divisao_dc.logic_environment'),
    # path('equipamento/<str:nome_equip>/ip/<int:x1>.<int:x2>.<int:x3>.<int:x4>/', environment_equip_resource.handle_request, name='environment.get.by.equipment_name.ip'),
    path('<int:id_ambiente>/', environment_resource.handle_request, name='environment.search.update.remove.by.pk'),
]
