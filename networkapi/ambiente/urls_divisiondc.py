...
urlpatterns = [
    path('', division_dc_add_resource.handle_request, name='division_dc.add'),
    path('all/', division_dc_get_all_resource.handle_request, name='division_dc.get.all'),
    path('<str:id_divisiondc>/', division_dc_alter_remove_resource.handle_request, name='division_dc.update.remove.by.pk'),
]
