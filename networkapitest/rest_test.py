...
#    '<vlan><nome>Teste6</nome><id_tipo_rede>9</id_tipo_rede><id_ambiente>11</id_ambiente><descricao>nada</descricao></vlan></networkapi>'
    ...
    status, response = RestClient().post(
        'http://localhost:8888/vlan/', xml, 'text/plain')
    print status
    print response
...
def insert_equipment():
    ...
    status, response = RestClient().post(
        'http://localhost:8888/equipamento/', xml, 'text/plain')
    print status
    print response
...
def insert_equipment_group():
    ...
    status, response = RestClient().post(
        'http://localhost:8888/equipamentogrupo/', xml, 'text/plain')
    print status
    print response
...
def remove_equipment_group():
    status, response = RestClient().delete(
        'http://localhost:8888/equipamentogrupo/equipamento/19/egrupo/3/')
    print status
    print response
...
def search_vlans_by_environment():
    status, response = RestClient().get(
        'http://localhost:8888/vlan/ambiente/4/')
    print status
    print response
...
def search_all_environments():
    ...
    status, response = RestClient().get(
        'http://localhost:8888/ambiente/divisao_dc/21/ambiente_logico/11/')
    print status
    print response
...
def insert_environment():
    ...
    status, response = RestClient().post(
        'http://localhost:8888/ambiente/', xml, 'text/plain')
    print status
    print response
...
def update_environment():
    ...
    status, response = RestClient().put(
        'http://localhost:8888/ambiente/61/', xml, 'text/plain')
    print status
    print response
...
def remove_environment():
    status, response = RestClient().delete(
        'http://localhost:8888/ambiente/61/')
    print status
    print response
...
def insert_ip_equipment():
    status, response = RestClient().put(
        'http://localhost:8888/ip/8781/equipamento/2010/', None)
...
#    '</networkapi>'
    ...
    status, response = RestClient().post(
        'http://localhost:8888/ip/', xml, 'text/plain')
    print status
    print response
...
def search_equipment_by_type_environment():
    status, response = RestClient().get(
        'http://localhost:8888/equipamento/tipoequipamento/1/ambiente/5/')
...
def get_equipment_by_name():
    status, response = RestClient().get(
        'http://localhost:8888/equipamento/nome/XXX/')
    print status
    print response
...
def remove_ip_equipment():
    ...
    status, response = RestClient().delete(
        'http://localhost:8888/ip/8780/equipamento/2010/')
    print status
    print response
...
def search_healthcheckexpect_by_environment():
    status, response = RestClient().get(
        'http://localhost:8888/healthcheckexpect/ambiente/51/')
    print status
    print response
...
#    '</networkapi>'
    ...
    status, response = RestClient().post(
        'http://localhost:8888/vip/', xml, 'text/plain')
    print status
    print response
...
def update_vip():
    xml = '<?xml version="1.0" encoding="UTF-8"?>' \
        ...
        '</networkapi>'
    status, response = RestClient().put(
        'http://localhost:8888/vip/41/', xml, 'text/plain')
    print status
    print response
...
def get_environment_by_equipname_ip():
    status, response = RestClient().get(
        'http://localhost:8888/ambiente/equipamento/XXXX/ip/10.249.35.11/')
    print status
    print response
...
def remove_equipment_by_pk():
    status, response = RestClient().delete(
        'http://localhost:8888/equipamento/11/')
    print status
    print response
...
def add_real_vip():
    status, response = RestClient().post(
        'http://localhost:8888/real/equip/631/vip/15/ip/962/', '', 'text/plain')
    print status
    print response
...
def del_real_vip():
    status, response = RestClient().delete(
        'http://localhost:8888/real/equip/481/vip/1/ip/20/')
    print status
    print response
...
def enable_disable_real_vip():
    status, response = RestClient().put(
        'http://localhost:8888/real/disable/equip/481/vip/1/ip/19/', '', 'text/plain')
    print status
    print response
...
#        '</networkapi>'
    ...
    status, response = RestClient().put(
        'http://localhost:8888/vlan/900/criar/', xml, 'text/plain')
    print status
    print response
...
def validate_vlan():
    status, response = RestClient().put(
        'http://localhost:8888/vlan/300/validar/', None)
    print status
    print response
...
#        '</networkapi>'
    ...
    status, response = RestClient().put(
        'http://localhost:8888/vlanl2/900/criar/', xml, 'text/plain')
    print status
    print response
...
#        '</networkapi>'
    ...
    status, response = RestClient().put(
        'http://localhost:8888/vlan/900/add/', xml, 'text/plain')
    print status
    print response
...
#        '</networkapi>'
    ...
    status, response = RestClient().put(
        'http://localhost:8888/vlan/900/del/', xml, 'text/plain')
    print status
    print response
...
def check_vlan_trunk():
    ...
    status, response = RestClient().put(
        'http://localhost:8888/vlan/900/check/', xml, 'text/plain')
    print status
    print response
...
def list_vlan_trunk():
    ...
    status, response = RestClient().put(
        'http://localhost:8888/vlan/list/', xml, 'text/plain')
    print status
    print response
...
def remove_virtual_group():
    ...
    status, response = RestClient().delete(
        'http://localhost:8888/grupovirtual/', xml, 'text/plain')
    print status
    print response
...
def list_equipment_type():
    status, response = RestClient().get(
        'http://localhost:8888/tipoequipamento/')
    print status
    print response
...
def check_ip_belong_environment():
    status, response = RestClient().get(
        'http://localhost:8888/ip/172.16.0.31/ambiente/15/')
...
def post_tipo_acesso():
    ...
    status, response = RestClient().post(
        'http://localhost:8888/tipoacesso/', xml, 'text/plain')
    print status
    print response
...
def put_tipo_acesso():
    ...
    status, response = RestClient().put(
        'http://localhost:8888/tipoacesso/4/', xml, 'text/plain')
    print status
    print response
...
def delete_tipo_acesso():
    status, response = RestClient().delete(
        'http://localhost:8888/tipoacesso/4/')
    print status
    print response
...
def get_equipamento_acesso():
    status, response = RestClient().get(
        'http://localhost:8888/equipamentoacesso/')
    print status
    print response
...
def post_equipamento_acesso():
    ...
    status, response = RestClient().post(
        'http://localhost:8888/equipamentoacesso/', xml, 'text/plain')
    print status
    print response
...
def put_equipamento_acesso():
    ...
    status, response = RestClient().put(
        'http://localhost:8888/equipamentoacesso/45/3/', xml, 'text/plain')
    print status
    print response
...
def delete_equipamento_acesso():
    status, response = RestClient().delete(
        'http://localhost:8888/equipamentoacesso/2/3/')
    print status
    print response
...
def create_brand():
    xml = '<?xml version="1.0" encoding="UTF-8"?>' \
        ...
        '</networkapi>'
    status, response = RestClient().post(
        'http://localhost:8888/marca/', xml, 'text/plain')
    print status
    print response
...
def update_brand():
    xml = '<?xml version="1.0" encoding="UTF-8"?>' \
        ...
        '</networkapi>'
    status, response = RestClient().put(
        'http://localhost:8888/marca/9/', xml, 'text/plain')
    print status
    print response
...
def update_remove_script_type():
    ...
    status, response = RestClient().delete(
        'http://localhost:8888/tiporoteiro/105/')
...
def search_insert_script():
    ...
    status, response = RestClient().post(
        'http://localhost:8888/roteiro/', xml, 'text/plain')
...
def update_remove_script():
    ...
    status, response = RestClient().delete(
        'http://localhost:8888/roteiro/108/')
...
def search_script_by_type():
    status, response = RestClient().get(
        'http://localhost:8888/roteiro/tiporoteiro/345345/')
    print status
    print response
...
def search_script_by_equip():
    status, response = RestClient().get(
        'http://localhost:8888/roteiro/equipamento/5/')
    print status
    print response
...
def search_insert_equip_scripts():
    ...
    status, response = RestClient().post(
        'http://localhost:8888/equipamentoroteiro/', xml, 'text/plain')
...
def remove_equip_scripts():
    status, response = RestClient().delete(
        'http://localhost:8888/equipamentoroteiro/1/234234/')
    print status
    print response
...
def search_model_by_brand():
    status, response = RestClient().get(
        'http://localhost:8888/modelo/marca/3/')
    print status
    print response
...
def update_model():
    xml = '<?xml version="1.0" encoding="UTF-8"?>' \
        ...
        '</networkapi>'
    status, response = RestClient().put(
        'http://localhost:8888/modelo/20/', xml, 'text/plain')
    print status
    print response
...
def search_front_back_interfaces():
    status, response = RestClient().get(
        'http://localhost:8888/interface/00:00:AE:FF:56:FA/equipamento/1959/')
    print status
    print response
...
def create_model():
    ...
    status, response = RestClient().post(
        'http://localhost:8888/modelo/', xml, 'text/plain')
    print status
    print response
...
def create_dc_division():
    ...
    status, response = RestClient().post(
        'http://localhost:8888/divisaodc/', xml, 'text/plain')
    print status
    print response
...
def update_dc_division():
    ...
    status, response = RestClient().put(
        'http://localhost:8888/divisaodc/25/', xml, 'text/plain')
    print status
    print response
...
def remove_dc_division():
    status, response = RestClient().delete(
        'http://localhost:8888/divisaodc/25/')
    print status
    print response
...
def create_vip():
    status, response = RestClient().put(
        'http://localhost:8888/vip/18/criar/', None)
    print status
    print response
...
def post_tipo_rede():
    ...
    status, response = RestClient().post(
        'http://localhost:8888/tiporede/', xml, 'text/plain')
    print status
    print response
...
def put_tipo_rede():
    ...
    status, response = RestClient().put(
        'http://localhost:8888/tiporede/20/', xml, 'text/plain')
    print status
    print response
...
def delete_tipo_rede():
    status, response = RestClient().delete(
        'http://localhost:8888/tiporede/21/')
    print status
    print response
...
def get_interface_equipamento():
    status, response = RestClient().get(
        'http://localhost:8888/interface/equipamento/1950/')
    print status
    print response
...
def post_interface_equipamento():
    ...
    status, response = RestClient().post(
        'http://localhost:8888/interface/', xml, 'text/plain')
    print status
    print response
...
def put_interface_equipamento():
    ...
    status, response = RestClient().put(
        'http://localhost:8888/interface/42/', xml, 'text/plain')
    print status
    print response
...
def delete_interface_equipamento():
    status, response = RestClient().delete(
        'http://localhost:8888/interface/15/')
    print status
    print response
...
def search_insert_user():
    ...
    status, response = RestClient().post(
        'http://localhost:8888/usuario/', xml, 'text/plain')
...
def search_logic_environment():
    status, response = RestClient().get(
        'http://localhost:8888/ambientelogico/')
    print status
    print response
...
def create_logic_environment():
    ...
    status, response = RestClient().post(
        'http://localhost:8888/ambientelogico/', xml, 'text/plain')
    print status
    print response
...
def update_logic_environment():
    ...
    status, response = RestClient().put(
        'http://localhost:8888/ambientelogico/23/', xml, 'text/plain')
    print status
    print response
...
def remove_logic_environment():
    status, response = RestClient().delete(
        'http://localhost:8888/ambientelogico/14/')
    print status
    print response
...
def insert_user_group():
    ...
    status, response = RestClient().post(
        'http://localhost:8888/usuariogrupo/', xml, 'text/plain')
    print status
    print response
...
def remove_user_group():
    status, response = RestClient().delete(
        'http://localhost:8888/usuariogrupo/usuario/1/ugrupo/2/')
    print status
    print response
...
def insert_ugroup():
    ...
    status, response = RestClient().post(
        'http://localhost:8888/ugrupo/', xml, 'text/plain')
...
def update_ugroup():
    ...
    status, response = RestClient().put(
        'http://localhost:8888/ugrupo/8/', xml, 'text/plain')
...
def insert_egroup():
    ...
    status, response = RestClient().post(
        'http://localhost:8888/egrupo/', xml, 'text/plain')
...
def update_egroup():
    ...
    status, response = RestClient().put(
        'http://localhost:8888/egrupo/6/', xml, 'text/plain')
...
def create_l3_group():
    ...
    status, response = RestClient().post(
        'http://localhost:8888/grupol3/', xml, 'text/plain')
    print status
    print response
...
def update_l3_group():
    ...
    status, response = RestClient().put(
        'http://localhost:8888/grupol3/47/', xml, 'text/plain')
    print status
    print response
...
def insert_equipment_environment():
    ...
    status, response = RestClient().post(
        'http://localhost:8888/equipamentoambiente/', xml, 'text/plain')
    print status
    print response
...
def remove_equipment_environment():
    status, response = RestClient().delete(
        'http://localhost:8888/equipamentoambiente/equipamento/1/ambiente/12/')
    print status
    print response
...
def search_insert_permission():
    ...
    status, response = RestClient().post(
        'http://localhost:8888/perms/', xml, 'text/plain')
...
def update_remove_permission():
    ...
    status, response = RestClient().put(
        'http://localhost:8888/perms/1234123/', xml, 'text/plain')
...
def get_direito_grupo_equipamento():
    ...
    status, response = RestClient().get(
        'http://localhost:8888/direitosgrupoequipamento/egrupo/10000/')
    print status
    print response
...
def post_direito_grupo_equipamento():
    ...
    status, response = RestClient().post(
        'http://localhost:8888/direitosgrupoequipamento/', xml, 'text/plain')
    print status
    print response
...
def put_direito_grupo_equipamento():
    ...
    status, response = RestClient().put(
        'http://localhost:8888/direitosgrupoequipamento/16/', xml, 'text/plain')
    print status
    print response
...
def delete_direito_grupo_equipamento():
    status, response = RestClient().delete(
        'http://localhost:8888/direitosgrupoequipamento/16/')
    print status
    print response
